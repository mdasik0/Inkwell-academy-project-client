...
const AddaClass = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch(`https://b7a12-summer-camp-server-side-mdasik0.vercel.app/addClass`, {
      method: "POST",
      headers: {
  ...
  return (
    <div className="">
      <Helmet>
        <title>Inkwell | Add a Class</title>
      </Helmet>
      <Title
        topHeader={"Add a class"}
        bottomTitle={
          "Add a class for the students status will be pending until the admin accepts it"
        }
      ></Title>
